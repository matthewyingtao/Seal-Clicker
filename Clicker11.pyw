...
class Unit:
    def __init__(self, name, cost, produce, y_button, page_number, frame, image):
        ...
        self.buy_unit_button = Button(frame,
                                      ...
                                      foreground="lightsteelblue1", activeforeground="lightsteelblue1", image=image,
...
seals_display = Label(root, font=("Georgia", 20), bg="steelblue4",
                      foreground="lightsteelblue1")
seals_display.place(relx=0.05, rely=0.01)

seal_button = Button(root, command=uni_values.seal_button, image=seal_image, bg="steelblue2",
