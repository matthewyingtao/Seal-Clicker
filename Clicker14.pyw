...
class UniversalValues:
    def __init__(self, font, theme):
        ...
        self.text_color = theme[1]
        self.disabled_text_color = theme[2]
        self.seal_button_color = theme[3]
        self.seal_button_active_color = theme[4]
        self.unit_button_color = theme[5]
        self.unit_button_active_color = theme[6]
        self.page_button_color = theme[7]
    ...
    def theme_change(self):
        ...
        seals_display.configure(bg=uni_values.background_color,
                                foreground=uni_values.text_color)
        per_second_display.configure(bg=uni_values.background_color,
                                     foreground=uni_values.text_color)
        seal_button.configure(bg=uni_values.seal_button_color,
                              activebackground=uni_values.seal_button_active_color)
        tick_rate_label.configure(bg=uni_values.unit_button_color,
                                  foreground=uni_values.text_color)
        settings_label.configure(bg=uni_values.unit_button_color,
                                 foreground=uni_values.text_color)
        themes_label.configure(bg=uni_values.unit_button_color,
                               foreground=uni_values.text_color)
        page_3_frame.configure(bg=uni_values.unit_button_color)
...
class Unit:
    def __init__(self, name, cost, produce, y_button, page_number, frame, image):
        ...
        self.buy_unit_button = Button(frame,
                                      ...
                                      font=(uni_values.font, 15), bg=uni_values.unit_button_color,
                                      activebackground=uni_values.unit_button_active_color,
        ...
        root.after(50, self.theme_change)
        if self.name != "Click":
    ...
    def theme_change(self):
        if self.buy_unit_button["bg"] != uni_values.unit_button_color:
            self.buy_unit_button.configure(bg=uni_values.unit_button_color,
                                           activebackground=uni_values.unit_button_active_color,
                                           foreground=uni_values.text_color, activeforeground=uni_values.text_color)
            self.max_buy_unit_button.configure(bg=uni_values.unit_button_color,
                                               activebackground=uni_values.unit_button_active_color,
                                               foreground=uni_values.text_color, activeforeground=uni_values.text_color)
        root.after(1000, self.theme_change)
...
class Page:
    def __init__(self, page_number):
        ...
        self.page_button = Button(root, text="page " + str(self.page_number), command=self.page_change,
                                  font=(uni_values.font, 15), bg=uni_values.page_button_color,
                                  activebackground=uni_values.unit_button_active_color,
                                  foreground=uni_values.text_color, activeforeground=uni_values.text_color,
                                  disabledforeground=uni_values.disabled_text_color)
        ...
        root.after(100, self.theme_change)
    ...
    def theme_change(self):
        if self.page_button["bg"] != uni_values.unit_button_color:
            self.page_button.configure(bg=uni_values.page_button_color,
                                       activebackground=uni_values.unit_button_active_color,
                                       foreground=uni_values.text_color, activeforeground=uni_values.text_color,
                                       disabledforeground=uni_values.disabled_text_color)
        root.after(50, self.theme_change)
...
uni_values = UniversalValues("Georgia", blue_theme)


def theme_change_blue():
    uni_values.theme = blue_theme
    uni_values.theme_change()


def theme_change_dark():
    uni_values.theme = dark_theme
    uni_values.theme_change()


def theme_change_burn_eyes():
    uni_values.theme = burn_eyes_theme
    uni_values.theme_change()
...
page_3_frame = Frame(background=uni_values.unit_button_color)

settings_label = Label(page_3_frame, text="Settings", font=(uni_values.font, 24), bg=uni_values.unit_button_color,
                       foreground=uni_values.text_color)
settings_label.place(relwidth=1, relx=0, rely=0)

tick_rate_label = Label(page_3_frame, text="Tick rate", font=(uni_values.font, 15), bg=uni_values.unit_button_color,
                        foreground=uni_values.text_color)
...
themes_label = Label(page_3_frame, text="Themes", font=(uni_values.font, 15), bg=uni_values.unit_button_color,
                     foreground=uni_values.text_color)
themes_label.place(relwidth=1, relx=0, rely=0.22)

dark_theme_button = Button(page_3_frame, font=(uni_values.font, 20), text="Dark Theme", command=theme_change_dark,
...
blue_theme_button = Button(page_3_frame, font=(uni_values.font, 20), text="Blue Theme", command=theme_change_blue,
...
seals_display = Label(root, font=(uni_values.font, 20), bg=uni_values.background_color,
                      foreground=uni_values.text_color)
...
per_second_display = Label(root, text="0 SPS", font=(uni_values.font, 20), bg=uni_values.background_color,
                           foreground=uni_values.text_color)
