    ...
    def __init__(self, name, cost, produce, buttony):
        ...
        self.buy_unit_button = Button(root,
                                      text="Buy " + self.name + "\n" + str(self.unit_cost) + " seals needed (" + str(
                                          self.units) + ")", command=self.unit_buy, font=("Georgia", 15), bg="steelblue3", activebackground="steelblue4", foreground="lightsteelblue1", activeforeground="lightsteelblue1")
        self.buy_unit_button.configure(highlightbackground="gold")
        ...
        self.max_buy_unit_button = Button(root, text="x0", command=self.max_buy_cost,
                                          font=("Georgia", 15), bg="steelblue3", activebackground="steelblue4", foreground="lightsteelblue1", activeforeground="lightsteelblue1")
...
seals_display = Label(root, text="You have no seals", font=("Georgia", 20), bg="steelblue4", foreground="lightsteelblue1")
seals_display.place(relx=0.05, rely=0.01)

seal_button = Button(root, text="Seal", command=intinfo.seal_button, image=seal_image, bg="steelblue2", activebackground="steelblue3")
