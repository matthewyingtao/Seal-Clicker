...
pink_theme = ["#8B3636", "#D7F2F0", "#632C24", "#D76173", "#E85A63", "#FF6363", "#D25252", "#D55D79"]
green_theme = ["#214F4B", "#FFE6FF", "#242B63", "#2ACC95", "#15C78B", "#0BB984", "#0AA978", "#16AD8F"]
...
class Unit:
    ...
    def click_update(self):
        self.unit_yield = (1.2 ** self.units) + self.units
...
pink_theme_button.place(relwidth=1, relheight=0.16, relx=0, rely=0.733)
...
dark_theme_button.place(relwidth=1, relheight=0.16, relx=0, rely=0.413)
