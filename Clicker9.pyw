...
class Unit:
    def __init__(self, name, cost, produce, y_button, page_number, frame):
        self.name = name
        self.units = 0
        self.unit_cost = cost
...
click = Unit("Click", 10, 1, 0, 1, page_1_frame)
osu_player = Unit("Osu Player", 15, 1, 0.18, 1, page_1_frame)
radar = Unit("Radar", 100, 10, 0.36, 1, page_1_frame)
factory = Unit("Factory", 2000, 50, 0.54, 1, page_1_frame)
astolfo_bean = Unit("Astolfo Bean", 50000, 250, 0.72, 1, page_1_frame)

page_2_frame = Frame()

collector = Unit("Collector", 50000, 250, 0, 2, page_2_frame)
hell = Unit("Hell", 50000, 250, 0.18, 2, page_2_frame)
certainlyt = Unit("CertainlyT", 50000, -250, 0.36, 2, page_2_frame)
beeg_seal = Unit("Beeg Seal", 50000, 250, 0.54, 2, page_2_frame)
hell_seal = Unit("Seal of Hell", 50000, 250, 0.72, 2, page_2_frame)
